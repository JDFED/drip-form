  ...
  actions: [
    {
      ...
      condintion: [
        ...
        {
          value1: 'a.a1 uiSchema disabled',
          operator: 'true',
          logicOperator: '||',
        },
        {
          value1: 'b.b1 uiSchema a',
          operator: '!==',
          value2: 'c',
          logicOperator: '&&',
        },
        {
          value1: 'c.c1 dataSchema default',
          operator: '===',
          value2: 'c',
          logicOperator: '&&',
        },
...
export const flowEffectTestData: Flow = {
  ...
  actions: [
    {
      type: 'controlFlow',
      condintion: [{ value1: 'b', operator: '!==', value2: 'c' }],
      effect: [
        {
          type:'set',
          fieldKey:'a data',
